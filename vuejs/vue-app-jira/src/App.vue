...
import JiraIssuesTable from '@/components/JiraIssuesTable.vue'
  ...
  methods: {
    ...
    async getJiraIssues() {
      try {
        ...
        const { data: response } = await axios.get('https://umerfarooq.atlassian.net//rest/api/2/search?jql=project=SUP&maxResults=10', {
          auth: {
